...
namespace Netytar
{
    ...
    /// </summary>
    public class AutoScroller_ButtonScroller : AutoScroller
    {
        public AutoScroller_ButtonScroller(ScrollViewer scrollViewer, int radiusThreshold, int proportional, IPointFilter filter) : base(scrollViewer, radiusThreshold, proportional, filter)
        {
