...
namespace Netytar.DMIbox.NithBSBehaviors
{
    ...
    internal class BSBehavior : INithSensorBehavior
    {
        ...
        public BSBehavior(bool bs_activate, float modulationMultiplier = 0.125f, float pressureMultiplier = 1f, float sensitivity = 1f, float pitchbendMultiplier = 1f)
        {
            this.BS_activate = bs_activate;
        ...
        public void HandleData(NithSensorData nithData)
        {
            ...
            if (R.UserSettings.BS_activateBreath == true)
            {
                ...
                if (nithData.GetArgument(NithArguments.press) != null)
                {
                    ...
                    // double input = 0.0;
                    R.NDB.BsSensor = nithData.GetArgument(NithArguments.press).Value.Base;


                    double input = valueProportional;
                    ...
                    R.NDB.TPSPressure = (int)(inputMap * pressureMultiplier); // Aggiorno la logica dello strumento cambiando la MIDI channel pressure
